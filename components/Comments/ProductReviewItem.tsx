...
export const ProductReviewItem = ({ review }: ProductReviewItemProps) => {
  ...
  return (
    <div
      className={`border-b-2 dark:border-b-slate-50/25 border-b-red-gray-200 my-4 p-2  ${
        isOptimistic ? "text-gray-400" : ""
      }`}
    >
      <div className="pb-2 flex justify-between w-full">
        <div className="text-xl font-bold pb-4 ">{review.headline}</div>
